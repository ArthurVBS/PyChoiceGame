...
def show(window, directory, roots, assets):
    ...
    def show_menu():
        #Labels
        lbl_menu_title = Label(roots['root_menu'], text = 'Rock - Paper - Scissors', font = 'courier 30 bold', bg=colors['white'], bd=1,
                                relief='sunken')
        ...
        #Buttons
        btn_menu_play = Button(roots['root_menu'], text = 'Jogar', font = 'courier 20 bold', bg=colors['white'], bd=3, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'],
                                command=lambda:click_show(window, directory, roots, assets, type='game'))
        btn_menu_play.place(x = 175, y = 130, width = 260, height = 50)

        btn_menu_tutorial = Button(roots['root_menu'], text = 'Tutorial', font = 'courier 20 bold', bg=colors['white'], bd=3, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'],
                                command=lambda:click_show(window, directory, roots, assets, type='tutorial'))
        btn_menu_tutorial.place(x = 175, y = 195, width = 260, height = 50)

        btn_menu_settings = Button(roots['root_menu'], text = 'Ajustes', font = 'courier 20 bold', bg=colors['white'], bd=3, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'], command=lambda:click_reset(assets))
        btn_menu_settings.place(x = 175, y = 260, width = 260, height = 50)

        btn_menu_credits = Button(roots['root_menu'], text = 'Créditos', font = 'courier 14 bold', bg=colors['white'], bd=1.5, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'],
                                command=lambda:click_show(window, directory, roots, assets, type='credits'))
        btn_menu_credits.place(x = 0, y = 330, width = 220, height = 30)

        btn_menu_quit = Button(roots['root_menu'], text = 'Sair', font = 'courier 14 bold', bg=colors['white'], bd=1.5, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'], command=lambda:click_quit(window))
    ...
    def show_game():
        ...
        #Data
        sub_root_data = Frame(roots['root_game'], bg=colors['white'])
        ...
        lbl_game_win = Label(sub_root_data, text=f'Vitórias: {status["win"]}', font='courier 12 bold', bg=colors['white'], fg=colors['green'])
        lbl_game_win.place(x = 25, y = 55, width = 170, height = 30)

        lbl_game_draw = Label(sub_root_data, text=f'Empates:  {status["draw"]}', font='courier 12 bold', bg=colors['white'], fg=colors['yellow'])
        lbl_game_draw.place(x = 25, y = 90, width = 170, height = 30)

        lbl_game_lose = Label(sub_root_data, text=f'Derrotas: {status["lose"]}', font='courier 12 bold', bg=colors['white'], fg=colors['red'])
        lbl_game_lose.place(x = 25, y = 125, width = 170, height = 30)

        lbl_game_player_image = Label(sub_root_data, image = assets['question_mark_dic'], bg=colors['white'])
        lbl_game_player_image.place(x = 25, y = 220, width = 70, height = 70)

        lbl_game_player_text = Label(sub_root_data, text = 'PLAYER', font = 'courier 12 bold', bg=colors['white'])
        lbl_game_player_text.place(x = 25, y = 295, width = 70, height = 30)

        lbl_game_cpu_image = Label(sub_root_data, image = assets['question_mark_dic'], bg=colors['white'])
        lbl_game_cpu_image.place(x = 125, y = 220, width = 70, height = 70)

        lbl_game_cpu_text = Label(sub_root_data, text = 'CPU', font = 'courier 12 bold', bg=colors['white'])
        ...
        lbl_game_version = Label(sub_root_back_next, text = version, font = 'courier 12 bold', bg=colors['dark'], fg=colors['white'])
        lbl_game_version.place(x = 220, y = 5, width = 170, height = 30)
        
        btn_game_back = Button(sub_root_back_next, text = 'Ir ao menu', font = 'courier 14 bold', bg=colors['dark'], bd=1.5, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'], fg=colors['white'],
                                command=lambda:click_show(window, directory, roots, assets, type='menu'))
        btn_game_back.place(x = 0, y = 5, width = 220, height = 30)

        btn_game_choice = Button(sub_root_back_next, text = 'Avançar', font = 'courier 14 bold', bg=colors['dark'], bd=1.5, relief='ridge',
                                cursor='hand2', activebackground=colors['gray'], fg=colors['white'],
    ...
    def show_credits():
        #Labels
        lbl_credits_title = Label(roots['root_credits'], text = 'Rock - Paper - Scissors', font = 'courier 30 bold',
        ...
        lbl_credits_line_02.place(x = 0, y = 325, width = 610, height = 5)
        ...
        lbl_credits_version = Label(roots['root_credits'], text = version, font = 'courier 12 bold', bg=colors['white'])
        lbl_credits_version.place(x = 220, y = 330, width = 170, height = 30)

        #Button
        btn_credits_back = Button(roots['root_credits'], text = 'Ir ao menu', font = 'courier 14 bold', bg=colors['white'],
                                cursor='hand2', activebackground=colors['gray'], bd=1.5, relief='ridge',
                                command=lambda:click_show(window, directory, roots, assets, type='menu'))
    ...
    def show_tutorial():
        #Labels
        text_tutorial = '- Pedra, Papel ou Tesoura -\n\n' +\
                        'Esse jogo consiste em ganhar uma disputa de um contra\n'+\
                        'um, tendo as mesmas opções que o seu adversário...'

        lbl_tutorial_title = Label(roots['root_tutorial'], text = text_tutorial, font = 'courier 14 bold',
                                bg=colors['white'], bd=1,relief='sunken')
